...
ALLOWED_HOSTS = ['jebsonstore-production.up.railway.app', 'https://jebsonstore-production.up.railway.app']
CSRF_TRUSTED_ORIGINS = ['https://jebsonstore-production.up.railway.app']
